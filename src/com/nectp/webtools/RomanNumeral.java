...
/**
* The following code was obtained with permission for use from http://math.hws.edu/eck/cs124/javanotes7/c8/ex3-ans.html
* Author: David J. Eck
* Version: 7.0
* Since: August 2014
*
...
public class RomanNumeral {
	...
	* by the parameter.  Throws a NumberFormatException if baseNum is
	* not in the range 1 to 3999 inclusive.
	*/
	public RomanNumeral(int baseNum) {
		if (baseNum < 1)
